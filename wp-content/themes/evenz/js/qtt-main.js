            ...
            *	Used by themeScroll
            ...
            stickyBarLink: function(st) {
                ...
                if (st >= wts) {
                    ...
                    o.OTSc.addClass('evenz-paper').css({
                        'top': smt + 'px'
                    });
                } else {
                ...
                applyTransformation: function(element, mouseXrel, mouseYrel) {
                    ...
                    if (element['enabled']) {
                        ...
                        if (element['low']) {
                            speed = 4;
                            element['bg1'].css({
                                "transform": "translate(" + mouseXrel * speed + "px, " + mouseYrel * speed + "px)"
                            });
                            ...
                            distance = 1.05;
                            mtx = [
                                [1, 0, 0, -mouseXrel * matrixFactor],
                                [0, 1, 0, -mouseYrel * matrixFactor],
                                [0, 0, 1, 1],
                                [0, 0, 0, distance]
                            ];
                            element['content'].css({
                                "transform": "perspective(" + perspective + "px) matrix3d(" + mtx.toString() + ") translate(" + mouseXrel * speed + "px, " + mouseYrel * speed + "px)"
                            });
                        }
                    }
                },
