    ...
    l.Defaults = {
        ...
        run: function() {
            var t = this.settings.rtl ? 1 : -1,
                ...
                n, o, r = [],
                a, h;
            for (a = 0, h = this._coordinates.length; a < h; a++) n = this._coordinates[a - 1] || 0, o = Math.abs(this._coordinates[a]) + e * t, (this.op(n, "<=", i) && this.op(n, ">", s) || this.op(o, "<", i) && this.op(o, ">", s)) && r.push(a);
        ...
        if (e.loop) i = this._clones.length / 2 + this._items.length - 1;
            ...
            if (s = this._items.length)
                for (n = this._items[--s].width(), o = this.$element.width(); s-- && !(o < (n += this._items[s].width() + this.settings.margin)););
            i = s + 1
        ...
        }, this)) : (this.settings.center ? (this.settings.rtl && (e = -1, i = t + 1), s = this._coordinates[t], s += (this.width() - s + (this._coordinates[i] || 0)) / 2 * e) : s = this._coordinates[i] || 0, s = Math.ceil(s))
...
function(a, o, t, h) {
        ...
        this._core = t, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a.proxy(function(t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                    for (var e = this._core.settings, i = e.center && Math.ceil(e.items / 2) || e.items, s = e.center && -1 * i || 0, n = (t.property && t.property.value !== h ? t.property.value : this._core.current()) + s, o = this._core.clones().length, r = a.proxy(function(t, e) {
                            this.load(e)
    ...
    e.Defaults = {
        ...
        !i || -1 < a.inArray(e.get(0), this._loaded) || (i.each(a.proxy(function(t, e) {
            var i = a(e),
                s, n = 1 < o.devicePixelRatio && i.attr("data-src-retina") || i.attr("data-src") || i.attr("data-srcset");
            ...
            }, this)).attr("srcset", n) : ((s = new Image).onload = a.proxy(function() {
                i.css({
...
function(o, i, t, e) {
    ...
    s.Defaults = {
        ...
        o.each(i, function(t, e) {
            s.push(o(e).height())
        }), n = Math.max.apply(null, s), this._core.$stage.parent().height(n).addClass(this._core.settings.autoHeightClass)
...
function(p, t, e, i) {
    var s = function(t) {
        ...
        }, this._core.options = p.extend({}, s.Defaults, this._core.options), this._core.$element.on(this._handlers), this._core.$element.on("click.owl.video", ".owl-video-play-icon", p.proxy(function(t) {
            this.play(t)
        }, this))
    };
    s.Defaults = {
        ...
        var i, s, n, o = t.width && t.height ? 'style="width:' + t.width + "px;height:" + t.height + 'px;"' : "",
            r = e.find("img"),
            a = "src",
            h = "",
            l = this._core.settings,
            c = function(t) {
                s = '<div class="owl-video-play-icon"></div>', i = l.lazyLoad ? '<div class="owl-video-tn ' + h + '" ' + a + '="' + t + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>', e.after(i), e.after(s)
            };
        ...
        "youtube" === t.type ? (n = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg", c(n)) : "vimeo" === t.type ? p.ajax({
            type: "GET",
        ...
        var e, i = p(t.target).closest("." + this._core.settings.itemClass),
...
function(r, t, e, i) {
    var s = function(t) {
        this.core = t, this.core.options = r.extend({}, s.Defaults, this.core.options), this.swapping = !0, this.previous = i, this.next = i, this.handlers = {
...
function(s, n, t, o) {
    ...
    var e = function(t) {
        this._core = t, this._hashes = {}, this.$element = this._core.$element, this._handlers = {
            ...
            s !== o && s !== this._core.current() && this._core.to(this._core.relative(s), !1, !0)
        }, this))
    };
    e.Defaults = {
        URLhashListener: !1
...
function(n, t, e, o) {
    ...
    function d(t) {
        ...
        return !!p("transition")
    })() && (n.support.transition = new String(d("transition")), n.support.transition.end = i.transition.end[n.support.transition]), c() && (n.support.animation = new String(d("animation")), n.support.animation.end = i.animation.end[n.support.animation]), s() && (n.support.transform = new String(d("transform")), n.support.transform3d = h())
}(window.Zepto || window.jQuery, window, document);
