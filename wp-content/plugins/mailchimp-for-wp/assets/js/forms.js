    ...
    var e = {
            ...
            1677: () => {
                function e(e) {
                    for (var t = !!e.getAttribute("data-show-if"), r = t ? e.getAttribute("data-show-if").split(":") : e.getAttribute("data-hide-if").split(":"), n = r[0], i = (r.length > 1 ? r[1] : "*").split("|"), a = function(e, t) {
                        ...
                        var l = a[s];
                        if (o = i.indexOf(l) > -1 || i.indexOf("*") > -1 && l.length > 0) break
                    }
                    e.style.display = t ? o ? "" : "none" : o ? "none" : "";
                    for (var u = e.querySelectorAll("input,select,textarea"), c = 0; c < u.length; c++) {
                        var f = u[c];
            ...
            7422: e => {
                ...
                e.exports = function(e, n) {
                    ...
                    for (var i = n.hash ? {} : "", s = n.serializer || (n.hash ? a : o), l = e && e.elements ? e.elements : [], u = Object.create(null), c = 0; c < l.length; ++c) {
                        var f = l[c];
                    ...
                    for (var i in r)
                        if (r.hasOwnProperty(i)) {
                            ...
                            if (s) switch (s.type || s[0].type) {
                                ...
                                case "radio":
                                        case "checkbox":
                                        for (var l = o.constructor === Array ? o : [o], u = 0; u < s.length; u++) s[u].checked = l.indexOf(s[u].value) > -1;
                                    break;
                                case "select-multiple":
                                        l = o.constructor === Array ? o : [o];
                                    for (var c = 0; c < s.options.length; c++) s.options[c].selected = l.indexOf(s.options[c].value) > -1;
                                    break;
                                case "select":
                                        case "select-one":
